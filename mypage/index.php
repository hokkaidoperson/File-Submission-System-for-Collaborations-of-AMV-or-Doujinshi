...
if ($_SESSION["state"] == 'p' or $_SESSION["state"] == 'c') {
    ...
    if ($remain_d and $remain_p) echo_alert('確認を行っていないファイル・情報があります。また、議論中のファイル・情報があります。<br>「提出作品の確認・承認」からご確認願います。', "primary", TRUE);
   else if ($remain_d) echo_alert('議論中のファイル・情報があります。<br>
「提出作品の確認・承認」からご確認願います。', "primary", TRUE);
   else if ($remain_p) echo_alert('確認を行っていないファイル・情報があります。<br>
「提出作品の確認・承認」からご確認願います。', "primary", TRUE);
}
...
<?php
if ($_SESSION["state"] == 'p') echo '<div style="width: 20rem; margin: 0.5rem;">
...
<div style="width: 20rem; margin: 0.5rem;">
<div class="card"><div class="card-body"><div class="media">
...
<div class="media-body">
<a href="exam/index.php" class="stretched-link"><h5>提出作品・情報の確認・承認</h5></a>
</div></div><hr>
<p class="card-text"><span class="text-decoration-none text-body">作品・情報が提出されたら、こちらから確認・承認を行って下さい。</span></p></div></div>
</div>
';
if ($_SESSION["state"] == 'c') echo '<div style="width: 20rem; margin: 0.5rem;">
<div class="card"><div class="card-body"><div class="media">
<img class="align-self-center mr-3" src="../images/upload.svg" style="width: 70px; height: 70px;">
<div class="media-body">
<a href="submit/index.php" class="stretched-link"><h5>作品を提出する</h5></a>
...
if ($_SESSION["state"] == 'g') echo '<div style="width: 20rem; margin: 0.5rem;">
<div class="card"><div class="card-body"><div class="media">
<img class="align-self-center mr-3" src="../images/upload.svg" style="width: 70px; height: 70px;">
<div class="media-body">
<a href="submit/index.php" class="stretched-link"><h5>作品を提出する</h5></a>
...
if ($_SESSION["admin"]) echo '<div style="width: 20rem; margin: 0.5rem;">
<div class="card"><div class="card-body"><div class="media">
