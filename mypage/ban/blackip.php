...
<p>ここで指定したIPアドレスもしくはリモートホストからのログインなどが制限されます。</p>
<p><b>一般参加者であり、かつシステム管理者でない者のログイン時</b>、もしくは<b>一般参加者の新規登録時</b>にこの制限が適用されます。<br>
システム管理者・主催者・共同運営者のログイン時、もしくは共同運営者の新規登録時にはこの制限は適用されません。</p>
