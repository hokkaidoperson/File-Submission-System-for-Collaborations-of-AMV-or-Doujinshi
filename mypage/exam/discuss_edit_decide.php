...
switch ($_POST["ans"]){
    case 1:
        register_alert("<p>結論を送信し、議論を終了しました。</p><p>承認しても問題無いという結論になったため、<b>この変更を承認しました</b>。<br>作品の提出者に承認の通知をしました。</p>", "success");
    break;
    case 2:
        register_alert("<p>結論を送信し、議論を終了しました。</p><p>問題があるという結論になったため、<b>この変更を拒否しました</b>。<br>作品の提出者に拒否の通知をしました。</p>", "success");
    break;
}
