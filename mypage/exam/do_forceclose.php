...
switch ($result){
    case 0:
        register_alert("<p>投票を強制的に締め切りました。</p><p>既に投票されていたデータを集計しました。<br>メンバー間で意見が分かれたため、<strong>この作品の承認・拒否について議論する必要があります</strong>。<br>以下の「議論中の作品・情報」の項目から、簡易チャット画面に移って下さい。</p>", "success");
    break;
    case 1:
    ...
    break;
    case 3:
        register_alert("<p>投票を強制的に締め切りました。</p><p>既に投票されていたデータを集計しました。<br>このイベントに相応しくないという意見で一致したため、<strong>この作品を拒否しました</strong>。<br>作品の提出者に拒否の通知をします。</p>", "success");
    break;
}
