...
switch ($result){
    case 0:
        ...
        else register_alert("<p>確認結果を送信しました。</p><p>全てのメンバーが共通情報の確認を終えました。<br>メンバー間で意見が分かれたため、<strong>この内容の承認可否について議論する必要があります</strong>。<br>以下の「確認未完了の提出物」の項目から、簡易チャット画面に移って下さい。</p>", "success");
    break;
    case 1:
        register_alert("<p>確認結果を送信しました。</p><p>全てのメンバーが共通情報の確認を終えました。<br>承認しても問題無いという意見で一致したため、<strong>この内容を承認しました</strong>。<br>情報の提出者に承認の通知をしました。</p>", "success");
    break;
    case 2:
        register_alert("<p>確認結果を送信しました。</p><p>全てのメンバーが共通情報の確認を終えました。<br>問題があるという意見で一致したため、<strong>この内容の承認を見送りました</strong>。<br>情報の提出者に承認見送りの通知をします。</p>", "success");
    break;
}
