...
switch ($result){
    case 0:
        ...
        else register_alert("確認結果を送信しました。<br><br>全てのメンバーが共通情報の確認を終えました。<br>メンバー間で意見が分かれたため、<b>この内容の承認・拒否について議論する必要があります</b>。<br>以下の「議論中の作品・情報」の項目から、簡易チャット画面に移って下さい。", "success");
    break;
    case 1:
        register_alert("確認結果を送信しました。<br><br>全てのメンバーが共通情報の確認を終えました。<br>承認しても問題無いという意見で一致したため、<b>この内容を承認しました</b>。<br>情報の提出者に承認の通知をしました。", "success");
    break;
    case 2:
        register_alert("確認結果を送信しました。<br><br>全てのメンバーが共通情報の確認を終えました。<br>問題があるという意見で一致したため、<b>この内容を拒否しました</b>。<br>情報の提出者に拒否の通知をします。", "success");
    break;
}
