...
switch ($result){
    case 0:
        ...
        else register_alert("<p>確認結果を送信しました。</p><p>全てのメンバーが共通情報の確認を終えました。<br>メンバー間で意見が分かれたため、<strong>この内容の承認・拒否について議論する必要があります</strong>。<br>以下の「議論中の作品・情報」の項目から、簡易チャット画面に移って下さい。</p>", "success");
    break;
    case 1:
    ...
    break;
    case 2:
        register_alert("<p>確認結果を送信しました。</p><p>全てのメンバーが共通情報の確認を終えました。<br>問題があるという意見で一致したため、<strong>この内容を拒否しました</strong>。<br>情報の提出者に拒否の通知をします。</p>", "success");
    break;
}
