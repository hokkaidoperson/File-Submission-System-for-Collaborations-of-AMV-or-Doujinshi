...
switch ($result){
    case 0:
        ...
        else register_alert("確認結果を送信しました。<br><br>全てのメンバーがこの作品の確認を終えました。<br>メンバー間で意見が分かれたため、<b>この作品の承認・拒否について議論する必要があります</b>。<br>以下の「議論中の作品・情報」の項目から、簡易チャット画面に移って下さい。", "success");
    break;
    case 1:
    ...
    break;
    case 2:
        register_alert("確認結果を送信しました。<br><br>全てのメンバーがこの作品の確認を終えました。<br>軽微な修正が必要であるという意見で一致したため、<b>この作品を修正待ち状態にしました</b>。<br>作品の提出者に、修正依頼の通知をします。", "success");
    break;
    case 3:
        register_alert("確認結果を送信しました。<br><br>全てのメンバーがこの作品の確認を終えました。<br>このイベントに相応しくないという意見で一致したため、<b>この作品を拒否しました</b>。<br>作品の提出者に拒否の通知をします。", "success");
    break;
}
