...
?> onChange="check_individual(&quot;ans&quot;);">
<label class="form-check-label" for="ans-3">内容面などの問題が多く、このイベントに相応しくないと思われます。</label>
</div>
<div id="ans-errortext" class="invalid-feedback" style="display: block;"></div>
</div>
<div class="form-group">
<label for="reason">「軽微な修正が必要」もしくは「内容面などの問題が多い」と答えた場合は、その理由を入力して下さい。（500文字以内）</label>
...
<form name="form_forceclose" action="do_forceclose.php" method="post" onSubmit="$('#forceclosemodal').modal(); return false;" style="margin-top:1em; margin-bottom:1em;">
<?php csrf_prevention_in_form(); ?>
