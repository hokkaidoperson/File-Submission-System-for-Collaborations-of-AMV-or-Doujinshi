...
<h1>イベント情報編集</h1>
<p>ここでは、ユーザー登録時に求める入力事項や、ファイル提出の期間・提出時の入力事項、ファイル確認に関する項目を設定出来ます。</p>
...
if (!file_exists(DATAROOT . 'examsetting.txt')) echo '<p><b>ファイル確認に関する設定をしていない</b>ため、このままではファイル提出を受け付け出来ません。この画面から、登録を完了させて下さい。</p>';
?>
<div class="row">
