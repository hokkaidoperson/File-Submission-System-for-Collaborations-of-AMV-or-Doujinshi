...
if (!isset($_GET['number']) or !isset($_SESSION["userformdata"][$number]["id"]) or ('textbox' != $_SESSION["userformdata"][$number]["type"]))
...
<div class="form-group">
<label for="prefix_a">入力欄の前に表示する文字（接頭辞）（50文字以内）</label>
...
<div class="form-group">
<label for="suffix_a">入力欄の後に表示する文字（接尾辞）（50文字以内）</label>
