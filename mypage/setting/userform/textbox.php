...
foreach($disable_status as $key => $disable) {
    $form_setting[] = [
        "prefill" => isset($_SESSION["userformdata"][$number]["prefix"][$key]) ? hsc($_SESSION["userformdata"][$number]["prefix"][$key]) : '',
...
foreach($disable_status as $key => $disable) {
    $form_setting[] = [
        "prefill" => isset($_SESSION["userformdata"][$number]["suffix"][$key]) ? hsc($_SESSION["userformdata"][$number]["suffix"][$key]) : '',
