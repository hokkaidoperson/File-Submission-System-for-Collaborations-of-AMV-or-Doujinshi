...
if (isset($_SESSION["userformdata"][$number]["max"])) echo htmlspecialchars($_SESSION["userformdata"][$number]["max"]);
?>">
</div>
<div class="input-group">
<div class="input-group-prepend">
...
if (isset($_SESSION["userformdata"][$number]["max2"])) echo htmlspecialchars($_SESSION["userformdata"][$number]["max2"]);
?>">
</div>
...
if (isset($_SESSION["userformdata"][$number]["min"])) echo htmlspecialchars($_SESSION["userformdata"][$number]["min"]);
?>">
</div>
<div class="input-group" style="width:19em;">
<div class="input-group-prepend">
...
if (isset($_SESSION["userformdata"][$number]["min2"])) echo htmlspecialchars($_SESSION["userformdata"][$number]["min2"]);
?>">
</div>
...
if (isset($_SESSION["userformdata"][$number]["width"])) echo htmlspecialchars($_SESSION["userformdata"][$number]["width"]);
?>">
...
if (isset($_SESSION["userformdata"][$number]["width2"])) echo htmlspecialchars($_SESSION["userformdata"][$number]["width2"]);
?>">
<div class="input-group-append">
<span class="input-group-text">em</span>
</div>
...
if (isset($_SESSION["userformdata"][$number]["prefix_a"])) echo htmlspecialchars($_SESSION["userformdata"][$number]["prefix_a"]);
?>">
</div>
<div class="input-group">
<div class="input-group-prepend">
...
if (isset($_SESSION["userformdata"][$number]["prefix_b"])) echo htmlspecialchars($_SESSION["userformdata"][$number]["prefix_b"]);
?>">
</div>
...
if (isset($_SESSION["userformdata"][$number]["suffix_a"])) echo htmlspecialchars($_SESSION["userformdata"][$number]["suffix_a"]);
?>">
</div>
<div class="input-group">
<div class="input-group-prepend">
...
if (isset($_SESSION["userformdata"][$number]["suffix_b"])) echo htmlspecialchars($_SESSION["userformdata"][$number]["suffix_b"]);
?>">
</div>
