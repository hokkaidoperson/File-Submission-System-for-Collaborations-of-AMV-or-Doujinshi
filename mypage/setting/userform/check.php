...
if (!isset($_GET['number']) or !isset($_SESSION["userformdata"][$number]["id"]) or ('check' != $_SESSION["userformdata"][$number]["type"]))
...
echo_textarea([
    ...
    "prefill" => isset($_SESSION["userformdata"][$number]["list"]) ? hsc($_SESSION["userformdata"][$number]["list"]) : '',
...
echo_check([
    ...
    "prefill" => isset($_SESSION["userformdata"][$number]["arrangement"][0]) ? [hsc($_SESSION["userformdata"][$number]["arrangement"][0])] : [],
