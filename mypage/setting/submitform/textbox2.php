...
if (!isset($_GET['number']) or !isset($_SESSION["submitformdata"][$number]["id"]) or ('textbox2' != $_SESSION["submitformdata"][$number]["type"]))
...
if (isset($_SESSION["submitformdata"][$number]["required"]) and $_SESSION["submitformdata"][$number]["required"] == "2") echo 'checked="checked"';
?>>
