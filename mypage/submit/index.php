...
<p>ファイルの提出期間は、<strong><?php echo date('Y年n月j日G時i分s秒', $general["from"]) . '～' . date('Y年n月j日G時i分s秒', $general["until"]); ?></strong>です。</p>
...
あと <strong>' . $submitleft . '作品</strong> 提出出来ます（' . $general["worknumber"] . '作品まで提出可能）。
</div>';
    }
    echo '<div class="system-carditems">
<div class="card system-cardindv">
<div class="card-header">
<a href="direct_unit.php" class="stretched-link">ファイルをサーバーに直接アップロードする</a>
</div>
<div class="card-body">
<span class="text-decoration-none text-body">ポータルサイトのサーバーに直接アップロード出来るファイルの最大サイズは <strong>' . $maxsize  . 'MB</strong> です。</span>
</div>
</div>
<div class="card system-cardindv">
<div class="card-header">
