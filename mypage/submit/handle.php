...
";
        ...
        if ($_POST["jumptocommonpage"]) register_alert("<p>ファイルの提出が完了しました。<br>ファイル内容を運営チームが確認するまでしばらくお待ち願います。</p><p>ファイル確認の結果、ファイルの再提出が必要になる可能性がありますので、<strong>制作に使用した素材などは、しばらくの間消去せずに残しておいて下さい</strong>。</p><p>続いて、共通情報の入力を行って下さい。</p>", "success");
        else register_alert("<p>ファイルの提出が完了しました。<br>ファイル内容を運営チームが確認するまでしばらくお待ち願います。</p><p>ファイル確認の結果、ファイルの再提出が必要になる可能性がありますので、<strong>制作に使用した素材などは、しばらくの間消去せずに残しておいて下さい</strong>。</p><p>続けて提出する場合は、再びこの画面から提出して下さい。</p>", "success");
        break;
    default:
        $nickname = $_SESSION["nickname"];
        $content = "$nickname 様
...
";
        ...
        if ($_POST["jumptocommonpage"]) register_alert("<p>ファイルの提出が完了しました。<br>ファイル確認の権限があるユーザー（主催者・共同運営者）があなたの他にいないため、この作品は<strong>自動的に承認されました</strong>。</p><p>続いて、共通情報の入力を行って下さい。</p>", "success");
        else register_alert("<p>ファイルの提出が完了しました。<br>ファイル確認の権限があるユーザー（主催者・共同運営者）があなたの他にいないため、この作品は<strong>自動的に承認されました</strong>。</p><p>続けて提出する場合は、再びこの画面から提出して下さい。</p>", "success");
}
