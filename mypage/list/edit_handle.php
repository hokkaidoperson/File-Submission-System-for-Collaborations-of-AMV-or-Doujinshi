...
";
        ...
        register_alert("<p>ファイルの編集が完了しました。<br>変更内容を運営チームが確認するまでしばらくお待ち願います。</p><p>ファイル確認の結果、ファイルの再提出が必要になる可能性がありますので、<strong>制作に使用した素材などは、しばらくの間消去せずに残しておいて下さい</strong>。</p>", "success");
        break;
    default:
        $nickname = $_SESSION["nickname"];
        $content = "$nickname 様
...
";
        ...
        register_alert("ファイルの編集が完了しました。<br>ファイル確認の権限があるユーザー（主催者・共同運営者）があなたの他にいないため、変更内容は<strong>自動的に承認されました</strong>。", "success");
}
