...
<p><strong>外部アップローダのURLで提出されたファイルについては、ダウンロードURL等がCSVファイル内に記載されますが、自動的にダウンロードされません。<br>
該当するファイルにつきましては、CSVファイルを確認し手動でダウンロード願います。</strong></p>
';
...
?>
<p>※扱うファイルの量によっては、<strong>ZIPファイルの生成が完了するまで数十秒掛かる可能性があります</strong>。</p>
