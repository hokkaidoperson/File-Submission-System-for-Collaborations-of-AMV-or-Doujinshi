...
<input type="text" name="msg_subject" class="form-control" id="msg_subject" value="Re: <?php echo hsc($data["_subject"]); ?>" onkeyup="show_length(value, &quot;subject-counter&quot;);" onChange="check_individual(&quot;subject&quot;);">
