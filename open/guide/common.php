...
<h1>共通情報について</h1>
<p>イベントにおいて<strong>ユーザー1人につき1つ必要な情報</strong>は、提出する作品とは別に共通情報として入力する事となります（「提出する各作品に共通する情報」という事から、「共通情報」という名前になっています）。</p>
...
<p>必要事項を入力（変更する際は変更したい項目のみ変更）し、<strong>最後に必ず「送信する」を押下して下さい</strong>（「送信する」を押下しないと送信されません。共通情報の入力・編集を取りやめる場合は、そのまま入力画面を離れて下さい。）。</p>
