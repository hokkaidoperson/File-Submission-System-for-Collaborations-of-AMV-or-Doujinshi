...
<p><img src="images/topscreen.png" class="img-fluid"><br><font size="2" class="text-muted">※実際の画面と異なる場合があります。</font></p>
...
<p><img src="images/mypagetop.png" class="img-fluid"><br><font size="2" class="text-muted">※実際の画面では、上部「テストケース」の部分には「<?php echo $eventname; ?>」と表示されます。また、他にも、実際の画面と異なる場合があります。</font></p>
...
<p><img src="images/logout.png" class="img-fluid"><br><font size="2" class="text-muted">※実際の画面では、あなたのニックネームや立場（主催者、一般参加者など）が表示されます。</font></p>
