...
<title>共同運営者登録手続 - <?php echo $eventname; ?>　ファイル提出用ポータルサイト</title>
</head>
...
あなたを新しい共同運営者として登録します。<br><br>
よろしければ、確認の為、あなたのユーザーIDとパスワードを入力して下さい。
</div>
<div class="border border-primary" style="padding:10px; margin-top:1em; margin-bottom:1em;">
<form name="form" action="newco_handle.php" method="post" onSubmit="return check()">
...
<br>
<button type="submit" class="btn btn-primary" id="submitbtn">共同運営者の登録を実行する</button>
</form>
</div>
</div>
</div>
