...
if (!isset($answerdata[$prom[0]])) continue;

//データを記録する
$answerdata[$prom[0]]["opinion"] = -1;
$answerdata[$prom[0]]["reason"] = "";
...
";
//内部関数で送信
sendmail(email($_POST["userid"]), '主催者の交代が完了しました', $content);
