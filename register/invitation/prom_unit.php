...
function check_individual(id) {
    ...
    if (id === "userid") {
        ...
        if(document.form.userid.value === ""){
            ...
            fetch('prom_useridcheck.php?userid=' + document.form.userid.value)
            .then((response) => {
                if(response.ok) {
    ...
    if (id === "email") {
        ...
        if(document.form.email.value === ""){
            ...
            fetch('prom_useridcheck.php?email=' + document.form.email.value)
            .then((response) => {
                if(response.ok) {
                    return response.json();
                } else {
...
function check(){
    ...
    fetch('prom_useridcheck.php?userid=' + document.form.userid.value + "&email=" + document.form.email.value)
    .then((response) => {
        if(response.ok) {
            return response.json();
        } else {
