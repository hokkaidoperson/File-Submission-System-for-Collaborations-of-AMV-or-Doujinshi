...
<?php
if ($userec) echo '<button class="g-recaptcha btn btn-primary" data-sitekey="' . $recdata["site"] . '" data-callback="recSubmit">送信する</button>';
else echo '<button type="submit" class="btn btn-primary" id="submitbtn">送信する</button>';
?>
</form>
</div>
</div>
